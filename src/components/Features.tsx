  ...
  return (
    <section id="features" className="py-24 md:py-32 bg-black text-white">
      <div className="container-custom">
        ...
        {/* Feature grid — clean 3-column bento */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group rounded-2xl border border-white/10 bg-white/[0.03] p-7 transition-colors hover:border-primary/40 hover:bg-white/[0.05]"
            >
